...
namespace Squidex.ClientLibrary
{
    ...
    public interface IContentsClient<TEntity, TData> where TEntity : Content<TData> where TData : class, new()
    {
        ...
        /// <exception cref="ArgumentException"><paramref name="id"/> is empty.</exception>
        Task<TEntity> ChangeStatusAsync(string id, ChangeStatus request, CancellationToken ct = default);
        ...
        /// <exception cref="ArgumentNullException"><paramref name="entity"/> is null.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="request"/> is null.</exception>
        Task<TEntity> ChangeStatusAsync(TEntity entity, ChangeStatus request, CancellationToken ct = default);
